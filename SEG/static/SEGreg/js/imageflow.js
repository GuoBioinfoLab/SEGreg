...
function ImageFlow() {
    ...
    this.defaults =
	{
        ...
        // onClick: function () { document.location = 'http://www.baidu.com'},
    ...
    /* Focus click*/
    this.linkClick = function(x){
        console.log(x);
        this.current = x;
        this.zIndex = my.max;
        
        var image = my.imagesDiv.childNodes[my.indexArray[1]];
        var currentImage = 1 * -my.xStep;
